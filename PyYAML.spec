...
%prep
%setup -q -n pyyaml-5.4.1
cd %{_builddir}/pyyaml-5.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612980130
...
cp %{_builddir}/pyyaml-5.4.1/LICENSE %{buildroot}/usr/share/package-licenses/PyYAML/3b8919c7f020e71fc3e97cfd724f9463bbac1177
