...
%prep
%setup -q -n pyyaml-5.3
cd %{_builddir}/pyyaml-5.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579194025
...
cp %{_builddir}/pyyaml-5.3/LICENSE %{buildroot}/usr/share/package-licenses/PyYAML/02f4ee02272b590193abf6302151a54e3055f503
...
/usr/share/package-licenses/PyYAML/02f4ee02272b590193abf6302151a54e3055f503
